...
# Remove existing .dll files in order to fail build if one of the ilasm commands fails
find "${UTILPACK_DIR}/" -mindepth 1 -maxdepth 1 -type d -exec rm "{}/UtilPack.dll" +
