...
namespace UtilPack.AsyncEnumeration.Enumerables
{
   ...
   internal sealed class EnumerableWrapper<T, U> : IAsyncEnumerable<U>
   {
   ...
   internal sealed class EnumerableWrapper<T, U, TArg> : IAsyncEnumerable<U>
   {
      private readonly IAsyncEnumerable<T> _enumerable;
