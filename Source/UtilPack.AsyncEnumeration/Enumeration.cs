...
namespace UtilPack.AsyncEnumeration
{
   ...
   public partial class DefaultAsyncProvider
   {
      ...
      private static async ValueTask<Int64> DoEnumerateAsync<T>(
...
public static partial class E_UtilPack
{
   ...
   public static ValueTask<Int64> EnumerateAsync<T>( this IAsyncEnumerable<T> enumerable, Action<T> action )
      => ( enumerable.AsyncProvider ?? DefaultAsyncProvider.Instance ).EnumerateAsync( enumerable, action );
   ...
   public static ValueTask<Int64> EnumerateAsync<T>( this IAsyncEnumerable<T> enumerable, Func<T, Task> asyncAction )
      => ( enumerable.AsyncProvider ?? DefaultAsyncProvider.Instance ).EnumerateAsync( enumerable, asyncAction );
   ...
   public static ValueTask<Int64> EnumerateAsync<T>( this IAsyncEnumerable<T> enumerable )
      => ( enumerable.AsyncProvider ?? DefaultAsyncProvider.Instance ).EnumerateAsync( enumerable );
