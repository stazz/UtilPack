...
public static partial class E_UtilPack
{
   ...
   public static async ValueTask<Boolean> AnyAsync<T>( this IAsyncEnumerable<T> source )
   {
      var retVal = false;
   ...
   /// <summary>
   /// Similarly to <see cref="System.Linq.Enumerable.Any{TSource}(IEnumerable{TSource}, Func{TSource, bool})"/>, this method checks whether this <see cref="IAsyncEnumerable{T}"/> contains at least one element, that satisfies condition checked by given <paramref name="predicate"/> synchronous callback.
   /// </summary>
   /// <typeparam name="T">The type of elements being enumerated.</typeparam>
   /// <param name="source">This <see cref="IAsyncEnumerable{T}"/>.</param>
   ...
   /// <exception cref="NullReferenceException">If this <see cref="IAsyncEnumerable{T}"/> is <c>null</c>.</exception>
   /// <seealso cref="System.Linq.Enumerable.Any{TSource}(IEnumerable{TSource}, Func{TSource, bool})"/>
   public static ValueTask<Boolean> AnyAsync<T>( this IAsyncEnumerable<T> source, Func<T, Boolean> predicate )
   {
      return predicate == null ? source.AnyAsync() : source.AnyAsync_NotNull( predicate );
   }

   /// <summary>
   /// Similarly to <see cref="System.Linq.Enumerable.Any{TSource}(IEnumerable{TSource}, Func{TSource, bool})"/>, this method checks whether this <see cref="IAsyncEnumerable{T}"/> contains at least one element, that satisfies condition checked by given <paramref name="asyncPredicate"/> potentially asynchronous callback.
   /// </summary>
   /// <typeparam name="T">The type of elements being enumerated.</typeparam>
   /// <param name="source">This <see cref="IAsyncEnumerable{T}"/>.</param>
   ...
   /// <exception cref="NullReferenceException">If this <see cref="IAsyncEnumerable{T}"/> is <c>null</c>.</exception>
   /// <seealso cref="System.Linq.Enumerable.Any{TSource}(IEnumerable{TSource}, Func{TSource, bool})"/>
   public static ValueTask<Boolean> AnyAsync<T>( this IAsyncEnumerable<T> source, Func<T, ValueTask<Boolean>> asyncPredicate )
   {
      return asyncPredicate == null ? source.AnyAsync() : source.AnyAsync_NotNull( asyncPredicate );
   }
   ...
   /// <seealso cref="System.Linq.Enumerable.All{TSource}(IEnumerable{TSource}, Func{TSource, bool})"/>
   /// <exception cref="NullReferenceException">If this <see cref="IAsyncEnumerable{T}"/> is <c>null</c>.</exception>
   /// <exception cref="ArgumentNullException">If <paramref name="predicate"/> is <c>null</c>.</exception>
   public static async ValueTask<Boolean> AllAsync<T>( this IAsyncEnumerable<T> source, Func<T, Boolean> predicate )
   {
   ...
   public static async ValueTask<Boolean> AllAsync<T>( this IAsyncEnumerable<T> source, Func<T, ValueTask<Boolean>> asyncPredicate )
   {
   ...
   private static async ValueTask<Boolean> AnyAsync_NotNull<T>( this IAsyncEnumerable<T> source, Func<T, Boolean> predicate )
   {
      var retVal = false;
      await source.EnumerateSequentiallyAsync( item =>
      {
   ...
   private static async ValueTask<Boolean> AnyAsync_NotNull<T>( this IAsyncEnumerable<T> source, Func<T, ValueTask<Boolean>> asyncPredicate )
   {
      var retVal = false;
      await source.EnumerateSequentiallyAsync( async item =>
      {
