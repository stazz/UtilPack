...
namespace UtilPack.AsyncEnumeration
{
   ...
   public partial class DefaultAsyncProvider
   {
      ...
      public IAsyncEnumerable<U> Select<T, U>( IAsyncEnumerable<T> enumerable, Func<T, U> selector )
      {
         ...
         return AsyncEnumerationFactory.FromTransformCallback( enumerable, selector, ( e, s ) => new SelectEnumerator<T, U>( e, s ) );
      }
      ...
      public IAsyncEnumerable<U> Select<T, U>( IAsyncEnumerable<T> enumerable, Func<T, ValueTask<U>> asyncSelector )
      {
         ...
         return AsyncEnumerationFactory.FromTransformCallback( enumerable, asyncSelector, ( e, s ) => new AsyncSelectEnumerator<T, U>( e, s ) );
      }
   }
...
public static partial class E_UtilPack
{
   ...
   public static IAsyncEnumerable<U> Select<T, U>( this IAsyncEnumerable<T> enumerable, Func<T, U> selector )
      => ( enumerable.AsyncProvider ?? DefaultAsyncProvider.Instance ).Select( enumerable, selector );
   ...
   public static IAsyncEnumerable<U> Select<T, U>( this IAsyncEnumerable<T> enumerable, Func<T, ValueTask<U>> asyncSelector )
      => ( enumerable.AsyncProvider ?? DefaultAsyncProvider.Instance ).Select( enumerable, asyncSelector );
