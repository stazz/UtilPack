...
namespace UtilPack.AsyncEnumeration
{
   ...
   public partial class DefaultAsyncProvider
   {
      ...
      public IAsyncEnumerable<U> SelectMany<T, U>( IAsyncEnumerable<T> enumerable, Func<T, IEnumerable<U>> selector )
      {
         ...
         return AsyncEnumerationFactory.FromTransformCallback( enumerable, selector, ( e, s ) => new SelectManyEnumeratorSync<T, U>( e, s ) );
      }
      ...
      public IAsyncEnumerable<U> SelectMany<T, U>( IAsyncEnumerable<T> enumerable, Func<T, IAsyncEnumerable<U>> asyncSelector )
      {
         ...
         return AsyncEnumerationFactory.FromTransformCallback( enumerable, asyncSelector, ( e, s ) => new SelectManyEnumeratorAsync<T, U>( e, s ) );
      }
   }
...
public static partial class E_UtilPack
{
   ...
   public static IAsyncEnumerable<U> SelectMany<T, U>( this IAsyncEnumerable<T> enumerable, Func<T, IEnumerable<U>> selector )
      => ( enumerable.AsyncProvider ?? DefaultAsyncProvider.Instance ).SelectMany( enumerable, selector );
   ...
   public static IAsyncEnumerable<U> SelectMany<T, U>( this IAsyncEnumerable<T> enumerable, Func<T, IAsyncEnumerable<U>> asyncSelector )
      => ( enumerable.AsyncProvider ?? DefaultAsyncProvider.Instance ).SelectMany( enumerable, asyncSelector );
}
