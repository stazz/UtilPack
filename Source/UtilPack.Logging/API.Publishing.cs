...
namespace UtilPack.Logging.Publish
{
   ...
   /// Then, the <see cref="Bootstrap.LogRegistration{TMetaData}.CreateHandlerFromCurrentRegistrations"/> is called to create instance of this interface, and is free to pass around to whatever code needs to perform logging.
